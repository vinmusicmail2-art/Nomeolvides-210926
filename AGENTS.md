...
- Текущая основная рабочая папка проекта: `U:\Ресторан Баски\АРХИВ ДЛЯ GITHUB 210926`.
- Все дальнейшие изменения по этому проекту вносить только в `U:\Ресторан Баски\АРХИВ ДЛЯ GITHUB 210926`, если пользователь отдельно не назначит другую папку.
